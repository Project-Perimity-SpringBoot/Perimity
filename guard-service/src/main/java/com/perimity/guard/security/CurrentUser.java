 ...
 *
 * This is the half of authorisation that @PreAuthorize cannot do.
 * hasRole('STUDENT') says a student may call an endpoint. It cannot say WHOSE
 * record they may touch. Without requireSelfOrStaff, any student reads another
 * account by changing the id in the URL - a 200 response to a request that
