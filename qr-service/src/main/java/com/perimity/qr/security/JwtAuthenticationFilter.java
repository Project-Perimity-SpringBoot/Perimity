 ...
 *
 * The same filter the other five services run, apart from the package. Silent
 * on failure by design: a bad token leaves the context empty and Spring
 ...
 *
 * NOT registered as a plain servlet filter. It is wired into the Spring
 * Security chain by SecurityConfig, which is what makes it run BEFORE the
 * authorization matchers rather than after them.
 */
@Component
