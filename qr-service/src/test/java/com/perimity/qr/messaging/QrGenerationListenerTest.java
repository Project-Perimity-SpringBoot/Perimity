...
class QrGenerationListenerTest {
    ...
    private PassEmailDispatcher passEmailDispatcher;
    ...
    void setUp() {
        ...
        passEmailDispatcher = Mockito.mock(PassEmailDispatcher.class);
        listener = new QrGenerationListener(
                validator, jobService, qrRecordService, resultPublisher, passEmailDispatcher);
    }
    ...
    void redeliveryRepublishesRatherThanRegenerating() {
        ...
        verify(passEmailDispatcher, never()).dispatch(anyLong(), any(), anyString());
