 ...
 * default provider chain finds them from environment variables locally and from
 * the EC2 instance role in production. An access key written into a properties
 * file is an access key that ends up in git.
 *
 ...
 * rather than never - which matters more here than in campus-service, because
 * what this bucket holds is people's photographs and identity documents.
 */
@Service
    ...
    public StoredObject put(String key, InputStream content, long sizeBytes, String contentType) {
        try {
            s3.putObject(PutObjectRequest.builder()
                            ...
                            // Server-side encryption at rest. One line, and it is
                            // the difference between a lost bucket being an
