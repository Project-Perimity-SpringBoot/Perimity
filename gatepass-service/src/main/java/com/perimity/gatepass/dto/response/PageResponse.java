 ...
 * about it. Four of the repositories return Page, so every list endpoint should
 * hand back this instead.
 *
 * Usage:
 *   PageResponse.from(repo.findByCampusIdOrderByCreatedAtDesc(id, pageable),
